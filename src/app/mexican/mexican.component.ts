...
@Component({
  ...
  styleUrl: './mexican.component.css'
})
export class MexicanComponent {
  constructor(private dish:MexicanService, private wish:WishlistService, private userorder:UserorderService){}
 ...
 date:any;
 ngOnInit(){
  this.dish.getdishes2().subscribe((data:any)=>{
    this.dishlist=data;
